...
public class GiaoVienDAO implements IGiaoVienDAO {
    ...
    public GiaoVien addNew(GiaoVien gv) {
        ...
        if (DBConnect.open()) {
            try {
                //   ps = DBConnect.cnn.prepareStatement("insert into tblGiangVien.MaGV, tblGiangVien.HoTenGV,tblGVMH.MaMH, tblGiangVien.NgaySinh, tblGiangVien.GioiTinh, tblGiangVien.Email, tblGiangVien.DiaChi, tblGiangVien.SDT from tblGiangVien inner join tblGVMH on tblGiangVien.MaGV=tblGVMH.MaGV values (?,?,?,?,?,?,?,?)");
