...
public class MonHocDAO implements IMonHocDAO {
    ...
    public MonHoc addNew(MonHoc mh) {
        ...
        if (DBConnect.open()) {
            try {
                ps = DBConnect.cnn.prepareStatement("insert into tblMonHoc(MaMH, TenMH,SoTrinh, HinhThucThi,HocKy,PhongHoc) values (?,?,?,?,?,?)");
    ...
    public MonHoc updateByID(MonHoc mh) {
        ...
        if (DBConnect.open()) {
            try {
                ps = DBConnect.cnn.prepareStatement("update tblMonHoc set TenMH=?,SoTrinh=?, HinhThucThi =?,HocKy =?,PhongHoc =? where MaMH =?");
